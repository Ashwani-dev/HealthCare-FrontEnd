      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
          <div className="flex items-center justify-center h-64">
            <Spinner size="lg" text="Loading your payments..." />
          </div>
        </div>
      </div>
    );
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4 mb-3 sm:mb-4">
                ...
                <div className="sm:col-span-2 lg:col-span-2 flex items-end gap-2 sm:gap-3">
                  ...
                  >
                    {listLoading ? (
                      <>
                        <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 border-2 border-white border-t-transparent rounded-full animate-spin inline-block"></div>
