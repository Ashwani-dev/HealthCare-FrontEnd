...
const DoctorRegisterForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg max-w-md mx-auto p-6">
      <div className="text-2xl font-bold text-blue-600 mb-6 text-center">Doctor Registration</div>
      ...
      <input name="specialization" placeholder="Specialization" className="w-full p-3 mb-3 border border-gray-300 rounded focus:border-blue-500" onChange={handleChange} required />
      <input name="medical_experience" type="number" placeholder="Medical Experience (years)" className="w-full p-3 mb-3 border border-gray-300 rounded focus:border-blue-500" onChange={handleChange} required />
