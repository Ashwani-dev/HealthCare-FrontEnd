              ...
              {expandedSections.specialization && (
                <div>
                  ...
                  {specializations.length > 5 && (
                    <Button variant="link" size="sm" onClick={() => toggleSeeMore("specialization")}>{seeMore.specialization ? "See Less" : "See More..."}</Button>
                  )}
                </div>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              {expandedSections.approach && (
                <div>
                  ...
                  {approaches.length > 5 && (
                    <Button variant="link" size="sm" onClick={() => toggleSeeMore("approach")}>{seeMore.approach ? "See Less" : "See More..."}</Button>
                  )}
                </div>
              )}
            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-xs mx-2 relative animate-fadeIn">
              ...
              <div className="flex gap-2 mt-4">
                <Button variant="primary" size="md" onClick={() => { applyFilters(); setShowFilters(false); }}>Apply Filters</Button>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-6">
                      ...
                      <div className="w-24 h-24 rounded-full bg-blue-200 flex items-center justify-center overflow-hidden flex-shrink-0">
                        {getAvatarUrl(profileData || profileDoctor) ? (
                          <img 
                            src={getAvatarUrl(profileData || profileDoctor)} 
                            alt={profileData.full_name || profileDoctor.full_name} 
                            className="w-full h-full object-cover" 
                          />
                        ) : (
